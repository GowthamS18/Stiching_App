...
@SuppressLint("NewApi")
public class ViewPayments extends Activity {
	String userid;
       ...
       sp1.setOnItemSelectedListener(new OnItemSelectedListener() {
           ...
           public void onItemSelected(AdapterView<?> parentView, View selectedItemView, int position, long id) {
               // your code here	            	
           	 ...
           	 String data=WebService.getList(sp1.getSelectedItem().toString(),"getPayments");		
	         if (!data.equals(""))
		     {
		   	 ...
		   	 {
		   		 Toast.makeText(ViewPayments.this,"No Records Found", Toast.LENGTH_LONG).show();  
		   		 tv1.setText("");
		   		 tv2.setText("");
		   		 tv3.setText("");
     	       	 tv4.setText("");
